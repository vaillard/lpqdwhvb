...
Public Class DWH_PEDIDOS_ATENDERLOGISTICA
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Dim cmd As New SqlCommand("SP_PEDIDO_PRELIBERAR_LOGISTICA", con) 'nombre del procedimiento, conn es la cadena de conexion
    ...
    Protected Sub GridView2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView2.SelectedIndexChanged
        ...
        Dim cmd As New SqlCommand("SP_PEDIDO_NO_PRELIBERAR_LOGISTICA", con) 'nombre del procedimiento, conn es la cadena de conexion
        cmd.CommandType = CommandType.StoredProcedure 'especificas que se ejecutara un procedimiento
        'envias los parametros
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim cmd As New SqlCommand("SP_PEDIDO_LIBERAR_LOGISTICA", con) 'nombre del procedimiento, conn es la cadena de conexion
        cmd.CommandType = CommandType.StoredProcedure 'especificas que se ejecutara un procedimiento
        'envias los parametros
